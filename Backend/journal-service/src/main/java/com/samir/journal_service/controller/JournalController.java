...
import com.samir.journal_service.Dto.JournalAutoSaveDTO;
import com.samir.journal_service.Dto.JournalRequestDTO;
import com.samir.journal_service.Dto.JournalStatsDTO;
import com.samir.journal_service.Dto.StreakDTO;
...
public class JournalController {
    ...
    public ResponseEntity<ApiResponse<com.samir.journal_service.Dto.ReflectionSummaryDTO>> getReflectionSummary(
            Authentication authentication,
        ...
        com.samir.journal_service.Dto.ReflectionSummaryDTO result = service.getReflectionSummary(userEmail, range, startDate, endDate);
        return ResponseEntity.ok(
                new ApiResponse<>(
                        true,
