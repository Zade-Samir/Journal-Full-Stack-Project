    ...
    <div className="min-h-screen w-full flex bg-bg-base font-sans text-text-primary">
      ...
      <div className="w-full lg:w-1/2 flex flex-col justify-center items-center p-8 sm:p-12 xl:p-24 relative">
        ...
        <div className="w-full max-w-sm">
          ...
          <div className="mb-8 text-center lg:text-left">
            ...
            <p className="text-sm text-text-secondary leading-relaxed">
              Simplify your thoughts and boost your mindfulness with The Quiet Room. Get started for free.
            </p>
          </div>

          {successMessage && (
            <div className="mb-6 p-3 rounded-xl bg-green-500/10 border border-green-500/20 flex gap-3 items-center text-green-500 text-sm">
          ...
          <form className="space-y-4" onSubmit={handleLogin}>
            ...
            <div className="flex justify-end pt-1">
              <a href="#" className="text-xs font-semibold hover:underline text-text-primary">Forgot Password?</a>
            </div>

            <button 
              type="submit" 
              disabled={loading}
              className="w-full py-3.5 mt-4 rounded-full bg-text-primary text-bg-base text-sm font-semibold tracking-wide hover:opacity-90 transition-colors shadow-lg flex items-center justify-center gap-2 disabled:opacity-70"
            >
          ...
          <div className="relative mt-10 mb-8">
            ...
            <div className="relative flex justify-center text-xs">
              <span className="bg-bg-base px-4 text-text-tertiary">or continue with</span>
            </div>
          </div>
        ...
        <div className="absolute bottom-8 text-xs text-center w-full pb-4">
          <span className="text-text-secondary">Not a member? </span>
          <Link to="/register" className="font-semibold text-text-primary hover:underline">Register now</Link>
        </div>
      </div>
      ...
      <div className="hidden lg:flex w-1/2 p-4">
        <div className="w-full h-full bg-brand/5 rounded-[2rem] flex flex-col justify-center items-center p-12 relative overflow-hidden">
           ...
           <div className="text-center z-10 mt-4">
              ...
              <p className="text-xl text-neutral-900 font-bold mt-1">
                with The Quiet Room
              </p>
           </div>
           ...
           <div className="flex items-center gap-2 mt-8">
             <div className="w-2 h-2 rounded-full bg-neutral-400/30"></div>
             <div className="w-6 h-2 rounded-full bg-neutral-900"></div>
             <div className="w-2 h-2 rounded-full bg-neutral-400/30"></div>
           </div>
